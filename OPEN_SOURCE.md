...
- The downloadable `speak-scripture` Skill package.
- Public images and static download files.
- Derived CUV corpus files under `references/cuv-corpus/`; the source edition is marked Public Domain by eBible.org and is documented in that directory.
