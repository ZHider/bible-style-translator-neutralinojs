...
const STORY_SIGNAL =
  /(?:来到|进屋|看见|听见|回答|问道|说道|说完|寒暄|随后|于是|后来|转身|离开|扑向|受伤|带着|起了冲突|发生冲突).{0,36}(?:他|她|他们|众人|那人|另一个人|冲突|离去|离开)|(?:一天|清晨|傍晚|晚上|夜里|后来|随后|于是|第二天|到了午后).{0,100}(?:来到|捡到|找到|拿出|交给|归还|拒绝|帮助|送来|离开|受伤|完成|交出|通过|道谢)|[\p{Script=Han}A-Za-z·]{2,6}(?:在|来到|带着|看见|捡到|找到|拿出|交给|归还|拒绝|帮助|离开|受伤).{0,100}(?:后来|随后|于是|第二天|便|就).{0,100}(?:来到|拿出|交给|归还|拒绝|帮助|送来|离开|受伤|完成|交出|通过|道谢)|[“"‘'][^”"’']{2,}[”"’']/u;
